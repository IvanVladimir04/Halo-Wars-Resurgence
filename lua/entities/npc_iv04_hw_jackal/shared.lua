...
ENT.Models  = {"models/halowars1/covenant/jackal.mdl"}
ENT.StartHealth = 50
ENT.Relationship = 2
ENT.MeleeDamage = 30
...
function ENT:Shoot(ent)
	...
	self:Face(ent)
	local seq = "Sniper Attack "..math.random(1,4)..""
...
function ENT:Wander()
	...
	if math.random(1,2) == 1 then
		...
		if math.random(1,2) == 1 then
			self:ResetSequence("Idle Combat "..math.random(1,3).."")
		else
...
list.Set( "NPC", "npc_iv04_hw_jackal", {
	Name = "Jackal",
	Class = "npc_iv04_hw_jackal",
