...
ENT.Models  = {"models/halowars1/flood/nest.mdl"}
...
ENT.SpawnableEntities = {
	...
	"npc_vj_hw_flood_elite",
	"npc_vj_hw_flood_flamethrower",
	"npc_vj_hw_flood_grunt",
	"npc_vj_hw_flood_marine",
	"npc_vj_hw_flood_marine",
	"npc_vj_hw_flood_grunt"
}

ENT.Squad = {
	["npc_vj_hw_flood_grunt"] = 1,
	["npc_vj_hw_flood_marine"] = 1,
	["npc_vj_hw_flood_brute"] = 1,
	["npc_vj_hw_flood_elite"] = 1,
	["npc_vj_hw_flood_flamethrower"] = 1
}
...
function ENT:CreateRagdoll(dmg)
	...
	if !self.DoFade then
		...
		timer.Simple( fr, function()
			if IsValid(en) then
				imbackbitch = ents.Create("npc_iv04_hw_nest")
...
list.Set( "NPC", "npc_iv04_hw_nest", {
	Name = "Flood Nest",
	Class = "npc_iv04_hw_nest",
