...
function ENT:CustomOnPriorToKilled(dmginfo,hitgroup)
    ...
    timer.Simple(1.4,function()
		if IsValid(self) then -- Will error if the carrier is unspawned, always add an IsValid()
			...
			local infectionform1 = ents.Create("npc_iv04_hw_flood_infection")
			local infectionform2 = ents.Create("npc_iv04_hw_flood_infection")
			local infectionform3 = ents.Create("npc_iv04_hw_flood_infection")
			local infectionform4 = ents.Create("npc_iv04_hw_flood_infection")
			local infectionform5 = ents.Create("npc_iv04_hw_flood_infection")
