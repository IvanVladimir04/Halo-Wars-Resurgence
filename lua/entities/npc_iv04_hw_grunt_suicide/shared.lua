...
ENT.Models  = {"models/halowars1/covenant/grunt_suicide.mdl"}
ENT.StartHealth = 50
ENT.Relationship = 2
ENT.MeleeDamage = 30
...
ENT.Quotes = {
	["Created"] = {
		"halowars1/characters/Grunt dialog/Sounds_2683.mp3",
		"halowars1/characters/Grunt dialog/Sounds_2719.mp3",
		"halowars1/characters/Grunt dialog/Sounds_2754.mp3",
		"halowars1/characters/Grunt dialog/Sounds_2807.mp3",
		"halowars1/characters/Grunt dialog/Sounds_2822.mp3",
		"halowars1/characters/Grunt dialog/Sounds_2849.mp3"
	},
	["FireEffectBig"] = {
		"halowars1/Covenant guns/Sounds_1896.mp3",
		"halowars1/Covenant guns/Sounds_1896.mp3",
		"halowars1/Covenant guns/Sounds_1896.mp3"
	},
	["FireEffectSmall"] = {
	...
	["Death"] = {
		"halowars1/characters/Grunt dialog/Sounds_499.ogg",
		"halowars1/characters/Grunt dialog/Sounds_460.ogg",
		"halowars1/characters/Grunt dialog/Sounds_634.ogg",
		"halowars1/characters/Grunt dialog/Sounds_441.mp3",
		"halowars1/characters/Grunt dialog/Sounds_408.mp3",
		"halowars1/characters/Grunt dialog/Sounds_599.ogg",
		"halowars1/characters/Grunt dialog/Sounds_414.mp3",
		"halowars1/characters/Grunt dialog/Sounds_479.ogg",
		"halowars1/characters/Grunt dialog/Sounds_520.ogg"
	}
}
...
function ENT:Shoot(ent)
	...
	self:Face(ent)
	local seq = "Attack "..math.random(1,4)..""
...
function ENT:Wander()
	...
	if math.random(1,2) == 1 then
		...
		if math.random(1,2) == 1 then
			self:ResetSequence("Idle "..math.random(1,6).."")
		else
...
list.Set( "NPC", "npc_iv04_hw_grunt_suicide", {
	Name = "Grunt Suicide",
	Class = "npc_iv04_hw_grunt_suicide",
...
function ENT:GetInfected(dmg)
	...
	if math.random(1,2) == 1 then
		...
		timer.Simple( len, function()
			if IsValid(p) then
				local flood = ents.Create("npc_iv04_hw_flood_grunt")
