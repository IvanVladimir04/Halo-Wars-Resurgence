...
ENT.Models  = {"models/halowars1/rebel/rebel_sniper.mdl"}
ENT.StartHealth = 50
ENT.Relationship = 4
ENT.MeleeDamage = 30
...
ENT.Quotes = {
	...
	["FireEffectBig"] = {
		"halowars1/characters/Marine/Sniper fire.mp3",
		"halowars1/characters/Marine/Sniper fire.mp3",
		"halowars1/characters/Marine/Sniper fire.mp3"
	},
	["FireEffectSmall"] = {
...
function ENT:Shoot(ent)
	...
	self:Face(ent)
	local seq = "Attack Sniper Rifle "..math.random(1,3)..""
...
list.Set( "NPC", "npc_iv04_hw_rebel_sniper", {
	Name = "Rebel Sniper",
	Class = "npc_iv04_hw_rebel_sniper",
